...
<html lang="en">
  ...
  <body class="text-center">
    <form class="form-signin" action="sign_up.php" method="post">
      ...
      <input type="date" id="dob" class="form-control"name="dob" placeholder="Enter Your Date of Birth" 
      required autofocus>
...
if(isset($_POST['submit'])){
    ...
    $query=mysqli_query($conn,"INSERT into jobseeker(email,password,first_name,last_name,dob,mobile_number)values('$email'
    ,'$Password','$first_name','$last_name','$dob','$mobile_number')");
// var_dump($query);
